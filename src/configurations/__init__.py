...
from src.configurations.environments import LunalabConf, LunaryardConf, LargeScaleTerrainConf, EarthConf
...
configFactory.registerConfig("earth_settings", EarthConf)
